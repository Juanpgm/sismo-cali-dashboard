...
- [x] 10.24 RED+GREEN edge: `test_admin_create_and_set_enabled_invalidate_roster_component` — the next request after either write costs exactly +1 roster scan; identical content keeps the version and costs 0 recompute; changed content costs exactly 1.
